...
namespace VisualGraph
{
    ...
    public class DrawLine : DrawObject
    {
        ...
        public override void WriteToXml(XmlDocument xmlDoc, XmlElement xmlElement)
        {
            ...
            xmlElement.SetAttribute("startPointX", startPoint.X.ToString());
            xmlElement.SetAttribute("startPointY", startPoint.Y.ToString());
            xmlElement.SetAttribute("endPointX", endPoint.X.ToString());
            xmlElement.SetAttribute("endPointY", endPoint.Y.ToString());
        }
        ...
        public override void ReadFromXml(XmlElement xmlElement)
        {
            ...
            string val;
            val = xmlElement.GetAttribute("startPointX");
            int x = Convert.ToInt32(val);
            val = xmlElement.GetAttribute("startPointY");
            int y = Convert.ToInt32(val);
            startPoint = new Point(x, y);
            val = xmlElement.GetAttribute("endPointX");
            x = Convert.ToInt32(val);
            val = xmlElement.GetAttribute("endPointY");
